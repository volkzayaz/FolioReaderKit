...
internal extension UIImage {
    ...
    func ignoreSystemTint(withColor color: UIColor) -> UIImage? {
...
internal extension UIViewController {
    ...
    func setCloseButton(withColor color: UIColor) {
        let closeImage = UIImage(readerImageNamed: "icon-navbar-close")?.ignoreSystemTint(withColor: color)
