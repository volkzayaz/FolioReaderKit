...
class ScrollScrubber: NSObject, UIScrollViewDelegate {
    ...
    init(frame:CGRect, withReaderContainer readerContainer: FolioReaderContainer) {
        ...
        let thumbImgColor = thumbImg?.imageTintColor(UIColor(rgba: "#eb3323"))?.withRenderingMode(.alwaysOriginal)
    ...
    func reloadColors() {
        slider.minimumTrackTintColor = UIColor(rgba: "#eb3323")
        slider.maximumTrackTintColor = UIColor(rgba: "#d1d1d6")
    }
